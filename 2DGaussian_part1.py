...
We separate this experiment into small sample sizes (part1) and large sample sizes (part2)
out of the consideration that the memory and time requirement in SLURM will be different.
'''
import os
import itertools
