// this code should works for multi dimensional data

functions {
  real logmultiNormKro(matrix G, int n, matrix Sigma){
    return -0.5*n*log_determinant(Sigma) -0.5*trace(Sigma\G'*G);
  }
